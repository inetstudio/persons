...
class PersonsBindingsServiceProvider extends ServiceProvider
{
    ...
    */
    public $bindings = [
        ...
        'InetStudio\Persons\Contracts\Observers\PersonObserverContract' => 'InetStudio\Persons\Observers\PersonObserver',
        ...
        'InetStudio\Persons\Contracts\Services\Back\PersonsObserverServiceContract' => 'InetStudio\Persons\Services\Back\PersonsObserverService',
